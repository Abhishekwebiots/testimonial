<section class="regular wi-slider">
    ...
    while( $loop->have_posts() ) {
        ...
        ?>
        <div class="wi-slide">
            <div class="wi-card wi-testimonial-card">
                <!--Background color-->
            ...
            <div class="wi-card-body">
                <!--Name-->
                <h3 class="wi-card-title wi-mt-1"><?php echo get_post_meta($post->ID,"_testimonials_author_name", true); ?></h3>
                ...
                <div class="wi-orange-text"> <span> <?php $value_testimonials_rate = get_post_meta($post->ID, "_testimonials_rate", true);
